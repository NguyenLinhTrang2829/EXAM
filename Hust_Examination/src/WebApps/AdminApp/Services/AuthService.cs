...
namespace AdminApp.Services
{
    public class AuthService : IAuthService
    {
        ...
        {
            _disco = await httpsClientDiscoveryExtensions.GetDiscoveryDocumentAsync(
               _httpsClient,
        ...
        private async Task<TokenResponse> RequestTokenAsync(string user, string password)
        {
            ...
            var response = await _httpsClient.RequestPasswordTokenAsync(new PasswordTokenRequest
            {
        ...
        public async Task LogoutAsync()
        {
            ...
            _httpsClient.DefaultRequestHeaders.Authorization = null;
        }
    }
}
