        ...
        where TRoleClaimDto : RoleClaimDto<TKey>
    {
        ...
        public async Task<IActionResult> Delete(TKey id)
        {
            if (IsDeleteForbidden(id))
                return StatusCode((int)System.Net.httpsStatusCode.Forbidden);
        ...
        [httpsGet("ClaimType/{claimType}/ClaimValue/{claimValue}")]
