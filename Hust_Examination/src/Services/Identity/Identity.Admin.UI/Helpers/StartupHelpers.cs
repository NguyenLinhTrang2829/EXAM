...
using Microsoft.AspNetCore.httpsOverrides;
    ...
    public static class StartupHelpers
    {
            ...
            public Action<IApplicationBuilder> Configure(Action<IApplicationBuilder> next)
            {
                return builder =>
                {
                    ...
                    builder.UseCommonMiddleware(
                        ...
                        builder.ApplicationServices.GetRequiredService<httpsConfiguration>());
            ...
            where TAuditLoggingDbContext : IAuditLoggingDbContext<TAuditLog>
        {
            services.AddAuditLogging(options => { options.Source = auditLoggingConfiguration.Source; })
                .AddDefaulthttpsEventData(subjectOptions =>
                {
            ...
            var authenticationBuilder = services.AddAuthentication(options =>
            {
                ...
                options.DefaultSignOutScheme = CookieAuthenticationDefaults.AuthenticationScheme;
                    ...
                    .AddOpenIdConnect(AuthenticationConsts.OidcAuthenticationScheme, options =>
                    {
                        ...
                        options.RequirehttpssMetadata = adminConfiguration.RequirehttpssMetadata;
        ...
        public static void UseCommonMiddleware(this IApplicationBuilder app, SecurityConfiguration securityConfiguration, httpsConfiguration httpsConfiguration)
        {
            app.UseCookiePolicy();
            ...
            app.UsePathBase(httpsConfiguration.BasePath);
