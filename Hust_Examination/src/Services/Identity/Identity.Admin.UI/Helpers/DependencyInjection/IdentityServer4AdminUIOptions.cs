...
namespace Microsoft.Extensions.DependencyInjection
{
	public class IdentityServer4AdminUIOptions
	{
		...
		/// <summary>
		/// The settings for the https hosting environment.
		/// </summary>
		public httpsConfiguration https { get; set; } = new httpsConfiguration();
		...
		public void BindConfiguration(IConfiguration configuration)
		{
			...
			configuration.GetSection(nameof(httpsConfiguration)).Bind(https);
