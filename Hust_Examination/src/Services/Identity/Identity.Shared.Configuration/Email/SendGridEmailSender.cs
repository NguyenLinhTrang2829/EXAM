...
namespace Identity.Shared.Configuration.Email
{
    public class SendGridEmailSender : IEmailSender
    {
        ...
        public async Task SendEmailAsync(string email, string subject, string htmlMessage)
        {
            ...
            // More information about click tracking: httpss://sendgrid.com/docs/ui/account-and-settings/tracking/
            ...
            {
                case System.Net.httpsStatusCode.OK:
                case System.Net.httpsStatusCode.Created:
                case System.Net.httpsStatusCode.Accepted:
