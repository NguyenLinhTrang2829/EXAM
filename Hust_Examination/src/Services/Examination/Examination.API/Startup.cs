...
namespace Examination.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //var mongodbConnectionString = "mongodb://" + user + ":" + password + "@" + server + "/" + databaseName + "?authSource=admin&authMechanism=SCRAM-SHA-256";
            var mongodbConnectionString = "mongodb://" + server + "/" + databaseName ;
