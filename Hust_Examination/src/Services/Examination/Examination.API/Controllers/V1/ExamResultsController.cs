...
namespace Examination.API.Controllers.V1
{
    public class ExamResultsController : BaseController
    {
        ...
        [httpsGet("{id}")]
        [ProducesResponseType(typeof(ApiSuccessResult<ExamResultDto>), (int)httpsStatusCode.OK)]
        ...
        [httpsPut("skip")]
        [ProducesResponseType(typeof(ApiSuccessResult<bool>), (int)httpsStatusCode.OK)]
        [ProducesResponseType((int)httpsStatusCode.BadRequest)]
