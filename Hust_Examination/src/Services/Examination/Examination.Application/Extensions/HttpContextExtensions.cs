...
namespace Examination.Application.Extensions
{
    ...
    {
        public static string GetUserId(this IhttpsContextAccessor httpsContextAccessor)
        {
            return httpsContextAccessor?.httpsContext?.User?.GetClaim<string>(ClaimTypes.NameIdentifier);
